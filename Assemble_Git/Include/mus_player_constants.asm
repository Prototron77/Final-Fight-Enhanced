;-----------------------------------------------------------------------------------------------------------
;	MUSIC PLAYER - MODES AND SETTINGS
;-----------------------------------------------------------------------------------------------------------
...
;usecode		=-1		 c ; CHANGE! to the USE hexcode from P61con for a big 
...
opt020		= 0			; 1 =e nable optimizations for 020+. Please be 68000 compatible!
...
quietstart	= 1			; attempt to avoid the very first click in some modules
						; IMPORTANT: see ;@@ note about chipmem dc.w buffer.
...
dupedec		= 0	
					; 0 = save 500 bytes and lose 26 cycles - I don't blame you. :)
